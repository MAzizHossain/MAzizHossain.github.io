...
function renderThemeTab() {
  return (
    '<button class="theme-tab" id="themeToggle" type="button" ' +
...
function loadPublications() {
  ...
  // This means the code only runs on publications.html.
  if (!container) return;
  ...
  fetch("publications.json")
    ...
    .then(function (data) {
      ...
      publications.forEach(function (publication) {
        ...
        // Create a new year heading when the year changes.
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Load publications if this is publications.html.
  loadPublications();
});
